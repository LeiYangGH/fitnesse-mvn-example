...
import static fitnesse.components.PluginsClassLoaderFactory.*;
...
//        new getClassLoader(""). PluginsClassLoader(getFitNesseDir(suiteClass)).addPluginsToClassLoader();
         PluginsClassLoaderFactory.getClassLoader(getFitNesseDir(suiteClass));
